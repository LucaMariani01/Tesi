...
public class AasFileGenerator {
     ...
     */
    public static void aasFileGeneratorMain(PDB currentPDB, int start, String outputPath, String ringResultPath , int unitNumber) {
        ...
        result = aasParser.readerEdges(new File(ringResultPath+"/"+edgesFileName+".pdb_ringEdges"),start);
